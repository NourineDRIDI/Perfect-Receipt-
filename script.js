        ...
        $('#recipeCardsContainer').append(`
            <div class="col-md-4 mb-4">
                <div class="card card-style">
                    <img src="${recipe.image}" class="card-img-top card-img-top-style" alt="${recipe.name}" loading="lazy">
                    <div class="card-body">
                        <p class="card-title fs-6">${recipe.name}</p>
                        <a href="./recipe-details.html#${recipe.id}" class="btn btn-outline-dark">View Recipe</a>
                    </div>
                </div>
            </div>
        `);
